...
3. Use one simple deterministic strategy
   ...
   - When player has more than $500 cash, should spend $200 on buildings and buy more than one house on cheaper streets: eg. 4x $50 or 2x $100.
   - When player has more than $1000 cash, should spend up to $450 on buildings and buy more than one house: 5x $50, 4x $100, 3x $150, 2x $200.
   - If the player owns at least one complete, unmortgaged street set, keep buying legal buildings until the spend cap or reserve rule stops further building
   ...
   - Buy each next legal building only if the player stays within the turn spend cap and keeps at least `$300` cash after paying the building cost
