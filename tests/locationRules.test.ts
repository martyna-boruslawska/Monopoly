...
test("locationRules - buys unowned property when player has enough funds", ctx => {
...
test("locationRules - skips purchase when funds are insufficient", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - buys unowned railroad when player has enough funds", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - buys unowned utility when player has enough funds", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - skips railroad purchase when funds are insufficient", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - pays property rent to another player", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - pays railroad rent to another player with 1 railroad owned", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - pays railroad rent to another player with 2 railroads owned", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - pays railroad rent to another player with 3 railroads owned", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - pays railroad rent to another player with 4 railroads owned", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - pays utility rent to another player with 1 utility owned", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - pays utility rent to another player with 2 utilities owned", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - skips utility rent payment when last roll total is unavailable", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - does not pay rent on self-owned properties", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - does not pay rent on self-owned railroad", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - does not pay rent on self-owned utility", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - handles missing owner safely when ownerId does not match any player", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - applies income tax deduction", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - applies income tax down to zero without marking player bankrupt", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - applies luxury tax deduction", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - marks player bankrupt and releases owned properties when money drops below zero", ctx => {
  ctx.mock.method(console, "log", () => {});
...
test("locationRules - marks player bankrupt after paying rent and releases owned properties", ctx => {
  ctx.mock.method(console, "log", () => {});
